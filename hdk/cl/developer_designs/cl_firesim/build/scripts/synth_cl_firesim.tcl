...
# Might not need to add files to the project
#add_files [glob $ENC_SRC_DIR/*.dat]
add_files [glob /home/centos/firesim/sim/firechip/hls_aes_decrypt_long/src/main/verilog/*.dat]
