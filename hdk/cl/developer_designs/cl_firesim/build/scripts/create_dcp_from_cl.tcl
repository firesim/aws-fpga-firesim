...
if {$implement} {
   ...
   if {$link} {
      ...
      read_xdc [ list \
         ...
         $CL_DIR/design/cl_firesim_constraints.xdc
      ]
      set_property PROCESSING_ORDER late [get_files cl_pnr_user.xdc]
      set_property PROCESSING_ORDER late [get_files cl_firesim_constraints.xdc]
   ...
   report_clocks -file $CL_DIR/build/reports/clock_list.rpt
